...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.rty9c.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
    ...
    try {
        ...
        app.get('/available', async (req, res) => {
            ...
            services.forEach(service => {
                ...
                // step 7: set availabel to slots to make it easier 
       ...
       * app.put("/booking/:id") // upsert => update (if exists) or insert (if dosn't exists)
...
app.get('/', (req, res) => {
    res.send('Hello from doctor uncle work here!')
})
